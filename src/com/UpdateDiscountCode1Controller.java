...
public class UpdateDiscountCode1Controller extends NavigationAdminCodes implements Initializable {
    ...
    @FXML
    public void switchToUpdateDiscountCode2(ActionEvent event) throws IOException, SQLException {
        ...
        if (isSelected) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("views/updateDiscountCode2.fxml"));
            Parent root = loader.load();
            UpdateDiscountCode2Controller updateDiscountCode2Controller = loader.getController();
            updateDiscountCode2Controller.setDiscountCode(id);
